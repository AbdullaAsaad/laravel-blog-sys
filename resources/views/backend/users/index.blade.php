                    ...
                    <div
                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr>
                                    <th
                                        ...
                                        Name</th>
                                    <th
                                        class="px-8 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                        Role</th>
                                    <th
                                        class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                        </th>
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr>
                                    <td class="px-2 py-3 whitespace-no-wrap border-b border-gray-200">
